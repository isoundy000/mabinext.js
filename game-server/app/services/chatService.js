...
ChatService.prototype.add = function(uid, playerName, channelName) {
  ...
  if(isAlreadyInChannel(this, uid, channelName)) {
    return Code.OK;
  }
  ...
  utils.myPrint('ChatService add uid =', uid, ", playerName = ", playerName, ", channelName = ", channelName);
...
ChatService.prototype.leave = function(uid, channelName) {
  ...
  if(channel && record) {
    ...
    utils.myPrint('ChatService leave uid =', uid, ", channelName = ", channelName);
 ...
 */
var isAlreadyInChannel = function(service, uid, channelName) {
